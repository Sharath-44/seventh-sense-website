import { projects } from '../../Data/womenEmpowermentData';
    ...
    return (
        <div className="bg-gray-100 py-12 pt-4">
            <div className="container mx-auto p-6">
                <h2 className="text-4xl font-bold mb-2 text-gray-800 text-center">Women Empowerment</h2>
                <div className="h-1 w-24 bg-blue-800 mx-auto mb-6"></div>
                <p className="text-center text-gray-600 mb-4">
                    Fostering an inclusive environment where women can access resources, opportunities, and support to lead and succeed in various fields, <br/>promoting gender equality and societal growth.
                </p>
                <p className="text-center text-2xl font-bold text-gray-600 mb-12">
                    Our Projects in Women Empowerment domain
                </p>
...
export default WomenEmpowermentProject;
