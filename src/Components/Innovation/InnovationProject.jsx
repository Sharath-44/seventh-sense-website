import { projects } from '../../Data/innovationData';
    ...
    return (
        <div className="bg-gray-100 py-12 pt-4">
            <div className="container mx-auto p-6">
                <h2 className="text-4xl font-bold mb-2 text-gray-800 text-center">Innovation & Entrepreneurship</h2>
                <div className="h-1 w-24 bg-blue-800 mx-auto mb-6"></div>
                <p className="text-center text-gray-600 mb-4">
                Encouraging creative thinking and entrepreneurial spirit, providing platforms and resources for individuals to develop groundbreaking ideas and transform them into successful ventures.
                </p>
                <p className="text-center text-2xl font-bold text-gray-600 mb-12">
                    Our Projects in Innovation & Entrepreneurship domain
                </p>
