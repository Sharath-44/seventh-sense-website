import { projects } from '../../Data/employmentData';
    ...
    return (
        <div className="bg-gray-100 py-12 pt-4">
            <div className="container mx-auto p-6">
                <h2 className="text-4xl font-bold mb-2 text-gray-800 text-center">Employment</h2>
                <div className="h-1 w-24 bg-blue-800 mx-auto mb-6"></div>
                <p className="text-center text-gray-600 mb-4">
                    Facilitating job opportunities and career advancement, connecting skilled workers with employers, and promoting sustainable employment practices for economic stability.
                </p>
                <p className="text-center text-2xl font-bold text-gray-600 mb-12">
                    Our Projects in Employment domain
                </p>
...
export default EmploymentProject;
